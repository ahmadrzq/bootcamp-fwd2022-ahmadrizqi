...
class ConsultationController extends Controller
{
    ...
    public function store(StoreConsultationRequest $request)
    {
        ...
        alert()->success('Success Message', 'Consultation has been created successfully!');
    ...
    public function update(UpdateConsultationRequest $request, Consultation $consultation)
    {
        ...
        alert()->success('Success Message', 'Consultation has been updated successfully!');
        return redirect()->route('backsite.consultation.index');
    }
    ...
    public function destroy(Consultation $consultation)
    {
        ...
        alert()->success('Success Message', 'Consultation has been deleted successfully!');
        return back();
    }
}
